<template>
  <div>
    ...
    <van-tabs swipeable animated sticky='true' :active="activeid" @change="onChange">
      <van-tab title="地图">
        <div class="tab-item-container map_container">
      ...
      <van-tab title="列表">
        <div class="tab-item-container" v-if="markersData">
          <div class="map_text" v-for="(item,index) in markersData" :key="index" @tap="handlemarker(item)">
...
export default {
  ...
  methods: {
    ...
    showMarkerInfo: function(data,i){
      ...
      //   url:"/api/station/queryByDistance",
      //   // data:{
